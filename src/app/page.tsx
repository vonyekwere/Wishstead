...
import { UserSearch, Sparkles, MailCheck, Gift, BookOpen } from "lucide-react";
const steps = [
  {
    number: "01",
    label: "Profile",
...
export default function Home() {
  return (
    <div>
      <section id="how-it-works" className="relative overflow-hidden min-h-[90vh]">
        ...
        <div className="relative container py-24 sm:py-32 lg:py-44">
          <div className="max-w-xl">
            <div className="mb-6 flex items-center gap-3 sm:gap-4">
              <span className="hidden h-px w-8 bg-maroon sm:block" />
        ...
        <div className='container'>
          ...
          <div className="mt-16 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {steps.map(({ number, label, description, icon: Icon }) => (
              <div
                key={number}
                className="relative flex w-full flex-col items-center rounded-3xl bg-[#F1EBE1] px-6 pt-10 pb-24"
              >
                ...
                {/* Title */}
                <h3 className="mt-6 text-2xl font-semibold text-[#2E2A24]">
                  {number}. {label}
                </h3>
      ...
      <section className="relative bg-[#EEEBE3] py-20 sm:py-32">
        <div className="mx-auto grid container grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          <div className="relative">
            ...
            <span
              aria-hidden="true"
              className="pointer-events-none absolute -left-2 -top-4 select-none font-serif text-[120px] leading-none text-[#C9A66B]/40 sm:-left-3 sm:-top-6 sm:text-[130px] xl:text-[160px]"
            >
              C
            </span>
